...
namespace BookReviewingAPI.Migrations
{
    ...
    [Migration("20230811232814_addIdentityTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookReviewingAPI.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BookReviewingAPI.Models.LocalUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BookReviewingAPI.Models.Author", b =>
                {
                    b.HasOne("BookReviewingAPI.Models.Country", "Country")
                        .WithMany("Authors")
            ...
            modelBuilder.Entity("BookReviewingAPI.Models.BookAuthor", b =>
                {
                    b.HasOne("BookReviewingAPI.Models.Author", "Author")
                        .WithMany("BookAuthors")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("BookReviewingAPI.Models.Book", "Book")
                        .WithMany("BookAuthors")
            ...
            modelBuilder.Entity("BookReviewingAPI.Models.BookCategory", b =>
                {
                    ...
                    b.HasOne("BookReviewingAPI.Models.Category", "Category")
                        .WithMany("BookCategories")
            ...
            modelBuilder.Entity("BookReviewingAPI.Models.Review", b =>
                {
                    ...
                    b.HasOne("BookReviewingAPI.Models.Reviewer", "Reviewer")
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BookReviewingAPI.Models.ApplicationUser", null)
                        .WithMany()
